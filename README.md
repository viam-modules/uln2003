...
| `ticks_per_rotation` | int | **Optional** | Number of steps in a rotation. A common stepper takes 5.625*(1/64)° per step. (default: 4096 when step_mode is "half", 2048 when step_mode is "full")
